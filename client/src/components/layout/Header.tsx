    ...
    <header className="h-14 bg-white border-b border-slate-200 flex items-center px-4 gap-3 shrink-0">
      ...
      <div className="relative" ref={accountMenuRef}>
        <button
          ...
          className="flex items-center gap-2 pl-2 border-l border-slate-200 rounded-lg px-2 py-1.5 hover:bg-slate-50 transition-colors"
        ...
        >
          ...
          <ChevronDown
            className={`hidden sm:block w-4 h-4 text-slate-400 transition-transform ${isAccountMenuOpen ? "rotate-180" : ""}`}
          />
        </button>

        {isAccountMenuOpen && (
          <div className="absolute right-0 top-12 w-72 bg-white border border-slate-200 rounded-xl shadow-lg z-50 overflow-hidden">
            ...
            <div className="p-2">
              ...
              {roleDefinition.menuActions.map((action) => (
                <button
                  key={action.label}
                  type="button"
                  onClick={() => handleAccountAction(action.path)}
              ...
              <div className="mt-2 border-t border-slate-200 pt-2">
                <button
                  ...
                  className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-red-600 hover:bg-red-50 transition-colors"
                >
